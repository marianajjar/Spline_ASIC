...
iq60_splinefloat =  float_minAJ2(iq60,L);
...
save_plots(iq60_splinefloat, fs1, '300Msps Spline float', 'after filtering');
plotIQfft(iq60_splinefloat,  fs1, 'FFT 60→300 spline float after filtering', 150);
