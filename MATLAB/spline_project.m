...
%% Create an input txt file to feed RTL
% Fixed iq60 in hexadecimal format

% L_val = 2;  % L FACTOR (2, 3, 4, or 5)
%
% % Odd L = 15-bit, Even L = 16-bit
%
% if mod(L_val, 2) ~= 0
%
%     wl = 15;
...
%
%
% % I-channel receives header
% I_stream_final = ...
%     [Header_Seq, I_stream];
%
%
% % Q-channel padding for alignment
% Q_stream_final = ...
%     ['0000', Q_stream];
%
%
% % Pad to 16-bit boundaries
...
%
%     I_stream_final = ...
%         [I_stream_final, padding];
%
%     Q_stream_final = ...
%         [Q_stream_final, padding];
%
% end
%
%
% % Save text file
% filename = ...
%     sprintf('input_L=%d.txt',L_val);
%
% fid = fopen(filename,'w');
%
% num_words = ...
%     length(I_stream_final)/16;
%
%
% for k = 1:num_words
%
...
%
%     chunk_I = ...
%         I_stream_final(idx_start:idx_end);
%
%     chunk_Q = ...
%         Q_stream_final(idx_start:idx_end);
%
%
%     hex_I = ...
%         dec2hex(bin2dec(chunk_I),4);
%
%     hex_Q = ...
%         dec2hex(bin2dec(chunk_Q),4);
%
%
%     fprintf(fid,'%s %s\n',hex_I,hex_Q);
%
