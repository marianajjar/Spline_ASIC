...
//
// PATCH (rev 2): added round-to-nearest bias before every truncating
//                arithmetic right shift. This kills the DC bias that
//                made VSA IQ-Offset ~-58 dB instead of ~-95 dB.
//   - eval_poly:        +2^14 before each '>>> 15'
//   - slope update m:   +2^13 before '>>> 14'
// ============================================================================
