...
file mkdir ./power_signoff/perL_rt
...
foreach L {2 3 4 5} {
  ...
  if {[catch { read_activity_file -format VCD $PS/vcd_rt_L${L}.vcd -scope tb_top_interpolator_dac/DUT -block I0 } e]} {
     puts "PERL L=$L read_activity FAILED: $e"
  }
  report_power -instances I0 -outfile ./power_signoff/perL_rt_rt/core_I0_L${L}.rpt
