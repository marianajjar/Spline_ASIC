...
file mkdir ./power_signoff/perL_saif_win
...
foreach L {2 3 4 5} {
  ...
  if {[catch { read_activity_file -format SAIF $PS/core_sf_L${L}.saif -scope tb_top_interpolator_dac/DUT -block I0 } e]} { puts "L=$L SAIF read err: $e" }
  report_power -instances I0 -outfile ./power_signoff/perL_saif_win/core_I0_L${L}.rpt
